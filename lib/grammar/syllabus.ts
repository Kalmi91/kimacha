...
export const GRAMMAR_SYLLABUS: SyllabusTopic[] = [
  ...
  // ========================= A2 =========================
  {
    ...
    level: 'A2',
    unit: 'a2-pasado',
    title: { hu: 'Befejezett múlt: szabályos igék', en: 'Preterite: regular verbs', es: 'Pretérito perfecto simple: regulares', de: 'Indefinido: regelmäßige Verben' },
  ...
  },
  {
    ...
    level: 'A2',
    unit: 'a2-pasado',
    title: { hu: 'Befejezett múlt: rendhagyó igék', en: 'Preterite: irregular verbs', es: 'Pretérito perfecto simple: irregulares', de: 'Indefinido: unregelmäßige Verben' },
  ...
  },
  {
    ...
    level: 'A2',
    unit: 'a2-pasado',
    title: { hu: 'Befejezett múlt, a 10 leggyakoribb ige', en: 'Preterite, the 10 most frequent verbs', es: 'Pretérito perfecto simple, los 10 verbos más frecuentes', de: 'Indefinido, die 10 häufigsten Verben' },
    blurb: { hu: 'Presente → indefinido átírás a 10 leggyakoribb igével.', en: 'Present → preterite rewrite drill with the 10 most frequent verbs.', es: 'Reescritura presente → perfecto simple con los 10 verbos más frecuentes.', de: 'Präsens-→-Indefinido-Umschreibung mit den 10 häufigsten Verben.' },
  },
  {
    id: 'imperfecto',
    level: 'A2',
  ...
  },
  {
    ...
    level: 'A2',
    unit: 'a2-pasado',
    title: { hu: 'Indefinido vagy imperfecto?', en: 'Preterite or imperfect?', es: '¿Pretérito perfecto simple o imperfecto?', de: 'Indefinido oder Imperfekt?' },
  ...
  // ========================= C1 =========================
  {
    ...
    level: 'C1',
    unit: 'c1-matices',
    title: { hu: 'Befejezett jövő és feltételes', en: 'Future and conditional perfect', es: 'Futuro compuesto y condicional compuesto', de: 'Futur II und Konditional II' },
