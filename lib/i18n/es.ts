export default {
  ...
  exam: {
    ...
    selfPartly: 'En parte',
    selfNo: 'Todavía no',
    speakingNote: 'La app no puede calificar el habla, así que esta prueba es de autoevaluación: hable en voz alta, compare con el modelo y valórese con honestidad.',
    speakingSelfNote: 'La prueba oral es su propia autoevaluación, no una nota automática.',
    verdictPass: 'APTO',
    verdictFail: 'NO APTO',
    apto: 'apto',
    noApto: 'no apto',
