export default {
  ...
  backup: {
    ...
    load: 'Cargar Progreso',
    saved: 'Progreso guardado en la carpeta de Descargas.',
    loaded: 'Progreso cargado.',
    noFile: 'No hay progreso guardado en el teléfono.',
    badFile: 'El archivo de copia está dañado o es desconocido.',
    permissionTitle: 'Permiso necesario',
    permissionMsg: 'Permite el acceso a "todos los archivos" para Kimacha y pulsa el botón otra vez.',
    openSettings: 'Ajustes',
    webOnly: 'La copia solo funciona en el teléfono.',
    confirmLoadTitle: 'Cargar Progreso',
    confirmLoadMsg: 'Tu progreso actual se sobrescribirá con el archivo guardado. ¿Continuar?',
    confirm: 'Sí',
  },
};
