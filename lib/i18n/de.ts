export default {
  ...
  talk: {
    title: 'Reden',
    subtitle: 'Wähle ein Thema, dann eine Stufe. Dasselbe Thema klingt auf A1 anders als auf C1.',
    readyLine: (n: number) => `${n} Themen fertig, der Rest entsteht gerade.`,
    topicsIn: (n: number) => `${n} Themen`,
    pickLevel: 'Auf welcher Stufe willst du darüber reden?',
    pickFormat: 'Wie willst du üben?',
    levelNoWords: 'Für dieses Thema gibt es auf dieser Stufe noch keine Wörter.',
    comingSoon: 'Demnächst',
    formatStory: 'Geschichte',
    formatStoryBlurb: 'Eine kurze Geschichte zum Thema, pro Szene eine Frage.',
    formatChat: 'Gespräch',
    formatChatBlurb: 'Ein Dialog, in dem du deine Antworten selbst wählst.',
    formatQuiz: 'Wort-Quiz',
    formatQuizBlurb: 'Der Wortschatz des Themas, eine richtige Antwort von vier.',
    quizPrompt: 'Was bedeutet das?',
    quizNext: 'Weiter',
    quizFinish: 'Beenden',
    quizResult: (correct: number, total: number) => `${correct} / ${total} richtig`,
    quizAgain: 'Nochmal',
    quizBack: 'Zurück',
    quizEmpty: 'Zu wenige Wörter für dieses Thema auf dieser Stufe.',
  },
  games: {
    title: 'Spiel',
    ...
    dictation: {
      promptNumber: 'Welche Zahl hast du gehört?',
      promptDate: 'Welches Datum hast du gehört?',
      placeholder: 'Schreib, was du gehört hast',
      check: 'Prüfen',
      next: 'Weiter',
      correct: 'Richtig!',
      result: (correct: number, total: number) => `${correct} / ${total} richtig`,
    },
    wordClass: {
      prompt: 'Welche Wortart ist das?',
      names: { noun: 'Nomen', verb: 'Verb', adj: 'Adjektiv', adv: 'Adverb' },
      next: 'Weiter',
      finish: 'Beenden',
      result: (correct: number, total: number) => `${correct} / ${total} richtig`,
      empty: 'Noch zu wenige einzuordnende Wörter. Lerne ein paar Karten und komm zurück.',
    },
    playAgain: 'Nochmal',
    backToHub: 'Zurück',
    score: 'Punkte',
    ...
    conjugationSlot: {
      comingSoon: 'Dieses Spiel ist vorerst nur auf Spanisch verfügbar.',
      notEnoughVerbs: 'Du hast noch nicht genug Verben in deinem Wortschatz für dieses Spiel.',
      progress: (current: number, total: number) => `${current} / ${total}`,
      includeIrregularLabel: 'Unregelmäßige Verben einschließen',
      questionCountLabel: 'Anzahl der Fragen',
      timeLimitLabel: 'Zeitlimit pro Frage',
      timeLimitNone: 'Kein',
      explanation: (person: string, tense: string, form: string) => `Die "${person}"-Form im ${tense}: ${form}`,
      tenseNames: {
        presente: 'Präsens',
        indefinido: 'Indefinido (Vergangenheit)',
        imperfecto: 'Imperfecto (Vergangenheit)',
        futuro: 'Futur',
        condicional: 'Konditional',
        subjuntivo_presente: 'Subjuntivo Präsens',
      },
    },
    // F5 (ccat, GAMES.md 4.10).
    ccat: {
      notEnoughContent: 'Du hast noch nicht genug Wörter/Inhalte für dieses Spiel.',
      progress: (current: number, total: number) => `${current} / ${total}`,
      questionCountLabel: 'Anzahl der Fragen',
      timeLimitLabel: 'Zeitlimit',
      timeLimitNone: 'Kein',
      timeLimitExam: 'Prüfungstempo',
      startIntro: (n: number, min: number) => `${n} Fragen, gemischte Typen. Im Prüfungstempo hast du ${min} Minuten für den ganzen Durchgang, und es gibt kein Zurück.`,
      startTimed: 'Prüfungstempo: die Uhr läuft für den ganzen Test.',
      startUntimed: 'Übungsmodus: keine Uhr.',
      timeUp: 'Die Zeit ist um.',
      typeMixLabel: 'Typ-Mix',
      typeMixAll: 'Alle',
      typeMixVerbal: 'Nur verbal',
      typeMixLogic: 'Nur Logik',
      promptLangLabel: 'Sprache der Fragen',
      promptLangLearned: 'Gelernte Sprache',
      promptLangNative: 'Muttersprache',
      typeBreakdownHeader: 'Aufschlüsselung nach Typ',
      reviewHeader: 'Sieh dir die falschen Fragen an',
      antonymPrompt: (word: string) => `Was ist das Gegenteil von "${word}"?`,
      antonymExplanation: (word: string, correct: string) => `Das Gegenteil von "${word}" ist: ${correct}.`,
      synonymPrompt: (word: string) => `Welches Wort bedeutet dasselbe wie "${word}"?`,
      synonymExplanation: (word: string, correct: string) => `Ein Synonym für "${word}" ist: ${correct}.`,
      analogyLabel: 'Vervollständige die Analogie',
      analogyExplanation: (a: string, b: string, c: string, d: string) => `${a} : ${b} verhält sich wie ${c} : ${d}.`,
      anagramPrompt: (scrambled: string) => `Ordne die Buchstaben zum Wort: ${scrambled.toUpperCase()}`,
      anagramExplanation: (word: string) => `Das richtige Wort ist: ${word}.`,
      numberSeriesPrompt: 'Was kommt als Nächstes in der Reihe?',
      numberSeriesExplanation: (answer: string) => `Die Reihe geht weiter mit: ${answer}.`,
      genderAdjF: 'weiblich',
      genderAdjM: 'männlich',
      genderAdjN: 'sächlich',
      instructionPrompt: (topicLabel: string, genderAdj: string) => `Tippe auf das Wort aus "${topicLabel}", das außerdem ${genderAdj} ist.`,
      instructionExplanation: (word: string, topicLabel: string, genderLabel: string) => `Das richtige Wort ist: ${word} (${topicLabel}, ${genderLabel}).`,
      wordProblemCalc: (a: number, opSymbol: string, b: number, answer: number) => `${a} ${opSymbol} ${b} = ${answer}`,
      typeLabels: {
        analogy: 'Analogie',
        antonym: 'Gegensatz',
        synonym: 'Synonym',
        oddOneOut: 'Der Außenseiter',
        sentenceFill: 'Satz Vervollständigen',
        anagram: 'Anagramm',
        numberSeries: 'Zahlenreihe',
        wordProblem: 'Textaufgabe',
        instruction: 'Anweisung Befolgen',
      },
    },
    ...
    myth: {
      comingSoon: 'Für diese Sprache gibt es noch keinen Inhalt.',
      intro: 'Rate: Stimmt die Aussage, oder ist es nur ein Mythos? Danach erfährst du die Wahrheit.',
      noTracksHint: 'Aktiviere mindestens eine Kategorie in den Einstellungen.',
      trackCommon: 'Volksglaube',
      trackBody: 'Körper und Essen',
      trackMexico: 'Mexiko / CDMX',
      trackLanguage: 'Die Sprache Selbst',
      lengthLabel: 'Rundenlänge',
      lengthEndless: 'Endlos',
      streak: (n: number) => `Serie: ${n}`,
      longestStreak: (n: number) => `Längste Serie: ${n}`,
      trueBtn: 'WAHR',
      mythBtn: 'MYTHOS',
      verdictTrue: 'Das stimmt.',
      verdictMyth: 'Das ist ein Mythos.',
      sourceLabel: 'Quelle:',
      wrongListHeader: 'Das wusstest du falsch:',
    },
    // F4 (story, GAMES.md 4.5).
    story: {
      comingSoon: 'Für diese Sprache gibt es noch keine Geschichten.',
      pickStory: 'Wähle eine Geschichte',
      track_cdmx: 'CDMX-Alltag',
      track_crime: 'Krimi / Rätsel',
      track_scifi: 'Sci-Fi / Abenteuer',
      estMinutes: (n: number) => `${n} Min.`,
      sceneOf: (current: number, total: number) => `Szene ${current} / ${total}`,
      showTranslation: 'Übersetzung anzeigen',
      continueBtn: 'Weiter',
      finishTitle: 'Geschichte fertig!',
      learnedWordsHeader: 'In dieser Geschichte hast du diese Wörter gelernt:',
      noNewWords: 'Diese Geschichte hatte keine neuen Wörter.',
      settingsFontSize: 'Schriftgröße',
      fontSmall: 'Klein',
      fontNormal: 'Normal',
      fontLarge: 'Groß',
      settingsTranslation: 'Übersetzung anzeigen',
      translationNever: 'Nie',
      translationTap: 'Bei Tippen',
      translationAlways: 'Immer',
      settingsSpeech: 'Szene vorlesen',
    },
    // F4 (chat, GAMES.md 4.6).
    chat: {
      comingSoon: 'Für diese Sprache gibt es noch keine Gespräche.',
      pickTopic: 'Wähle ein Thema',
      checklistLabel: (n: number) => `Checkliste mit ${n} Punkten`,
      checklistProgress: (done: number, total: number) => `${done} / ${total}`,
      endingChecklistHeader: 'Checkliste zu diesem Thema:',
      achievedTag: 'Gefragt',
      missedTag: 'Verpasst',
      sourceLabel: 'Quelle:',
      viewChecklistBtn: 'Checkliste ansehen',
      betterWouldBe: 'Besser wäre gewesen:',
    },
  },
  active: {
    title: 'Aktiver Modus',
  ...
  settings: {
    ...
    requeueDifficulty: 'Schwierigkeit',
    requeueDifficultyHint: 'Wie viele Karten vergehen, bis ein falsches Wort zurückkommt. Größerer Abstand = echtes Abrufen, kein Kurzzeitgedächtnis.',
    requeueEasy: 'Leicht (5 Karten)',
    requeueNormal: 'Normal (12 Karten)',
    requeueHard: 'Schwer (25 Karten)',
  },
  backup: {
    backup: 'Sicherung',
