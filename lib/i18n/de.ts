export default {
  ...
  exam: {
    ...
    selfNo: 'Noch nicht',
    speakingNote: 'Die App kann Sprechen nicht bewerten, deshalb ist dieser Teil eine Selbsteinschätzung: laut sprechen, mit dem Modell vergleichen und sich ehrlich bewerten.',
    speakingSelfNote: 'Der Sprechteil ist deine eigene Selbsteinschätzung, keine Maschinennote.',
