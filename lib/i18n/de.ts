export default {
  ...
  backup: {
    ...
    saved: 'Fortschritt im Downloads-Ordner gespeichert.',
    loaded: 'Fortschritt geladen.',
    noFile: 'Kein gespeicherter Fortschritt auf dem Telefon gefunden.',
    badFile: 'Die Sicherungsdatei ist beschädigt oder unbekannt.',
    permissionTitle: 'Berechtigung nötig',
    permissionMsg: 'Erlaube Kimacha den Zugriff auf "alle Dateien" und drücke die Taste erneut.',
    openSettings: 'Einstellungen',
    webOnly: 'Sicherung funktioniert nur auf dem Telefon.',
    confirmLoadTitle: 'Fortschritt Laden',
    confirmLoadMsg: 'Dein aktueller Fortschritt wird durch die gespeicherte Datei überschrieben. Fortfahren?',
    confirm: 'Ja',
  },
};
