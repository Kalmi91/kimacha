export default {
  ...
  backup: {
    save: 'Haladás Mentése',
    load: 'Haladás Betöltése',
    saved: 'Haladás elmentve a Letöltések mappába.',
    loaded: 'Haladás betöltve.',
    noFile: 'Nincs mentett haladás a telefonon.',
    badFile: 'A mentésfájl sérült vagy ismeretlen.',
    permissionTitle: 'Engedély kell',
    permissionMsg: 'Engedélyezd az „összes fájl" hozzáférést a Kimacha appnak, majd nyomd meg újra a gombot.',
    openSettings: 'Beállítások',
    webOnly: 'A mentés csak telefonon működik.',
    confirmLoadTitle: 'Haladás Betöltése',
    confirmLoadMsg: 'A mostani haladásod felülíródik a mentett fájllal. Folytatod?',
    confirm: 'Igen',
  },
};
