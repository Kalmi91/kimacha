export default {
  ...
  exam: {
    ...
    selfPartly: 'Részben',
    selfNo: 'Még nem',
    speakingNote: 'A beszédet az app nem tudja pontozni, ezért ez a rész önértékeléses: mondd el hangosan, hasonlítsd össze a mintával, és értékeld magad őszintén.',
    speakingSelfNote: 'A beszédkészség-rész a saját önértékelésed, nem gépi pontszám.',
