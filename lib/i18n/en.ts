export default {
  ...
  games: {
    ...
    wordClass: {
      prompt: 'Which word class is this?',
      names: { noun: 'Noun', verb: 'Verb', adj: 'Adjective', adv: 'Adverb' },
      next: 'Next',
      finish: 'Finish',
      result: (correct: number, total: number) => `${correct} / ${total} correct`,
      empty: 'Not enough sortable words yet. Learn a few cards and come back.',
    },
  ...
  settings: {
    ...
    requeueDifficulty: 'Difficulty',
    requeueDifficultyHint: 'How many cards pass before a missed word comes back. A longer gap means real recall, not short-term memory.',
    requeueEasy: 'Easy (5 cards)',
    requeueNormal: 'Normal (12 cards)',
    requeueHard: 'Hard (25 cards)',
  },
  backup: {
    backup: 'Backup',
    restore: 'Restore',
