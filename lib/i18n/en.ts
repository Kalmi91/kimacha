export default {
  ...
  backup: {
    save: 'Save Progress',
    load: 'Load Progress',
    saved: 'Progress saved to the Downloads folder.',
    loaded: 'Progress loaded.',
    noFile: 'No saved progress found on the phone.',
    badFile: 'The backup file is corrupt or unknown.',
    permissionTitle: 'Permission needed',
    permissionMsg: 'Allow "all files access" for Kimacha, then press the button again.',
    openSettings: 'Settings',
    webOnly: 'Backup only works on the phone.',
    confirmLoadTitle: 'Load Progress',
    confirmLoadMsg: 'Your current progress will be overwritten by the saved file. Continue?',
    confirm: 'Yes',
  },
};
