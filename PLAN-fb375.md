...
- [ ] 2. FB379 why-drillnél a fordítás elárulja a megoldást → kész, ha: a `tr` sor alapból rejtve, gombbal előhozható, válasz után magától látszik, jest-teszt rá, kapu zöld
